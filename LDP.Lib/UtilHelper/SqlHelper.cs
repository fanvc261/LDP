...
namespace LDP.Lib.Data
{
    public static class SqlHelper
    {
        ...
        public static IDataReader ExecuteCommand(string connectionString, string sqlCommand, params SqlParameter[] commandParameters)
        {
        ...
        {
            int commandTimeout = 6000; //30 seconds default http://msdn.microsoft.com/en-us/library/system.data.sqlclient.sqlcommand.commandtimeout.aspx
        ...
        {
            int commandTimeout = 6000; //30 seconds default
        ...
        public static DataSet ExecuteDataset_ARITHABORT(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            int commandTimeout = 30; //30 seconds default
            ...
            {
                connection.Open();
                using (SqlCommand command = new SqlCommand("SET ARITHABORT ON "))
                {
                    PrepareCommand(command, connection, (SqlTransaction)null, commandType, commandText, commandParameters);
