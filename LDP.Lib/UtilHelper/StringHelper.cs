...
namespace LDP.Lib.Common
{
    ...
    public static class StringHelper
    {
        ...
        public static string TableToJsonString(DataSet ds)
        {
        ...
        public static string ToAsciiIfPossible(this string s)
        {
            ...
            //Forums/Thread.aspx?thread=8974&mid=34&pageid=5&ItemID=9
            s = s.Replace("æ", "ae");
            s = s.Replace("Æ", "ae");
            s = s.Replace("å", "aa");
            s = s.Replace("Å", "aa");
            ...
            // based on:
            ///Forums/Thread.aspx?thread=9176&mid=34&pageid=5&ItemID=9&pagenumber=1#post38114
        ...
        {
            return System.Web.HttpContext.GetGlobalResourceObject(key, res).ToString();
        }
        #endregion
